<?php
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_category WHERE category_id = '$id' ORDER BY category_id DESC");
	$row_title_danhmuc = mysqli_fetch_array($sql);
?>
<!-- top Products -->
<div class="ads-grid py-sm-5 py-4">
	<div class="container py-xl-4 py-lg-2">
		<!-- tittle heading -->
		<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3"><?php echo $row_title_danhmuc['category_name'] ?></h3>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img style="image-rendering: pixelated;" src="images/<?php echo $row_product['sanpham_image'] ?>" alt="">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price"><?php echo number_format($row_product['sanpham_giakhuyenmai']).'vnđ' ?></span>
												<del><?php echo number_format($row_product['sanpham_gia']).'vnđ' ?></del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="?quanly=giohang" method="post">
													<fieldset>
														<input type="hidden" name="namesp" value="<?php echo $row_product['sanpham_name'] ?>" />
														<input type="hidden" name="idsp" value="<?php echo $row_product['sanpham_id'] ?>" />
														<input type="hidden" name="pricesp" value="<?php echo $row_product['sanpham_giakhuyenmai'] ?>" />
														<input type="hidden" name="imagesp" value="<?php echo $row_product['sanpham_image'] ?>" />
														<input type="hidden" name="quantitysp" value="<?php echo $row_product['sanpham_soluong'] ?>" />
							...
							<div class="scroll">
								...
								<div class="row">
									...
									<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
										...
										<a href="" class="price-mar mt-2"><?php echo number_format($row_product_sidebar['sanpham_giakhuyenmai']).'vnđ' ?></a>
